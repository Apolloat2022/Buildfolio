...
// Reusable Step Templates ( Generic enough for all, or lightly customized)
const GENERIC_STEPS = [
  {
    order: 1,
    ...
    videoUrl: 'https://www.youtube.com/embed/VSB2h7mVhPg', // Using E-commerce video as placeholder
    hints: [
  ...
  },
  {
    ...
    description: 'Implement the primary functionality of the application (e.g. Task list, Weather display, etc.).',
       ...
       for (const stepTmpl of GENERIC_STEPS) {
          await prisma.step.create({
            data: {
              ...
              ...stepTmpl,
              // Customize title slightly? No, stick to consistent structure for now.
            }
          })
       }
    } else {
