...
export async function GET() {
  try {
    ...
    const projects = [
      { slug: 'todo-app', title: 'Build a To-Do App', description: 'Create a task management app with React, TypeScript, and local storage.', difficulty: 'beginner', timeEstimate: '8-10 hours', technologies: ['React', 'TypeScript', 'Tailwind CSS'], steps: [
      ...
      { slug: 'weather-app', title: 'Build a Weather App', description: 'Create a weather dashboard with real-time data from OpenWeather API.', difficulty: 'beginner', timeEstimate: '10-12 hours', technologies: ['React', 'TypeScript', 'API'], steps: [
      ...
      { slug: 'social-dashboard', title: 'Build a Social Media Dashboard', description: 'Create a social feed with posts, likes, and comments.', difficulty: 'intermediate', timeEstimate: '20-25 hours', technologies: ['Next.js', 'Prisma', 'PostgreSQL'], steps: [
      ...
      { slug: 'recipe-finder', title: 'Build a Recipe Finder', description: 'Search recipes and create meal plans using API.', difficulty: 'beginner', timeEstimate: '12-15 hours', technologies: ['React', 'API', 'TypeScript'], steps: [
      ...
      { slug: 'portfolio-builder', title: 'Build a Portfolio Website', description: 'Create a professional portfolio with projects and blog.', difficulty: 'beginner', timeEstimate: '15-18 hours', technologies: ['Next.js', 'MDX', 'Tailwind'], steps: [
